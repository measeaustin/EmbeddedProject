...
bool initializeADC(  uint32_t adc_base )
{
  ...
  // for sample sequencer #3.
		...
		myADC->EMUX |= 0x00000000; //processor event is always zero

  // ADD CODE
  // Set IE0 and END0 in SSCTL3
		
  myADC->SSCTL3 = (ADC_SSCTL0_END0 | ADC_SSCTL0_IE0);
